...
syn keyword tasmDirective MULTERRS NAME NEAR %NEWPAGE %NOCONDS %NOCREF %NOCTLS
syn keyword tasmDirective NOEMUL %NOINCL NOJUMPS %NOLIST NOLOCALS %NOMACS
syn keyword tasmDirective NOMASM51 NOMULTERRS NOSMART %NOSYMS %NOTRUNC NOWARN OFFSET
...
syn keyword tasmDirective SETFLAG SHORT SIZESTR SMALLSTACK SMART STACK STARTUPCODE
...
syn region tasmString start='"' end='"'
" syn region tasmLabel start='\<[A-Z]\>' end=':'
